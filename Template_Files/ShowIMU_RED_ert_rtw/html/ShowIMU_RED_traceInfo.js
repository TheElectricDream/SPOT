function RTW_rtwnameSIDMap() {
	...
	this.rtwnameHashMap["<S1>"] = {sid: "ShowIMU_RED:92"};
	this.sidHashMap["ShowIMU_RED:92"] = {rtwname: "<S1>"};
	...
	this.rtwnameHashMap["<Root>/MATLAB Function"] = {sid: "ShowIMU_RED:92"};
	this.sidHashMap["ShowIMU_RED:92"] = {rtwname: "<Root>/MATLAB Function"};
	...
	this.rtwnameHashMap["<S1>:1"] = {sid: "ShowIMU_RED:92:1"};
	this.sidHashMap["ShowIMU_RED:92:1"] = {rtwname: "<S1>:1"};
