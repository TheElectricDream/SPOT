...
noise_variance_RED             = 0.0000001;
noise_variance_BLACK           = 0.0000001;
noise_variance_BLUE            = 0.0000001;
...
drop_states_RED           = [ 3; 0.5; pi];           % [m; m; rad]
drop_states_BLACK         = [ 2.25; 0.5; 0];         % [m; m; rad]
drop_states_BLUE          = [ 3; 0.5; pi];           % [m; m; rad]

init_states_RED           = [ xLength/2+0.4; yLength/2; pi]; % [m; m; rad]
init_states_BLACK         = [ xLength/2-0.4; yLength/2; 0];      % [m; m; rad]
