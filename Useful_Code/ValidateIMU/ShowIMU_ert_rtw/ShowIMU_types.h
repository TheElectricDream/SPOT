...
//
#ifndef RTW_HEADER_ShowIMU_types_h_
#define RTW_HEADER_ShowIMU_types_h_
#include "rtwtypes.h"
...
typedef struct tag_RTM_ShowIMU_T RT_MODEL_ShowIMU_T;

#endif                                 // RTW_HEADER_ShowIMU_types_h_
