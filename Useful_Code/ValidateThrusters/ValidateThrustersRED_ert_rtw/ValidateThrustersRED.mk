###########################################################################
## Makefile generated for Simulink model 'ValidateThrustersRED'. 
## 
## Makefile     : ValidateThrustersRED.mk
## Generated on : Sat Oct 17 11:44:30 2020
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ValidateThrustersRED.elf
...
PRODUCT_NAME              = ValidateThrustersRED
MAKEFILE                  = ValidateThrustersRED.mk
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = $(MATLAB_WORKSPACE)/C/Users/AlexC/Desktop/SPOT3/Useful_Code/ValidateThrusters
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ValidateThrustersRED.elf
...
DEFINES_STANDARD = -DMODEL=ValidateThrustersRED -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2020a/toolbox/realtime/targets/raspi/server/MW_pigs.c $(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2020a/toolbox/realtime/targets/raspi/server/system.c $(START_DIR)/ValidateThrustersRED_ert_rtw/ValidateThrustersRED.c $(START_DIR)/ValidateThrustersRED_ert_rtw/ValidateThrustersRED_data.c $(START_DIR)/ValidateThrustersRED_ert_rtw/rtGetInf.c $(START_DIR)/ValidateThrustersRED_ert_rtw/rtGetNaN.c $(START_DIR)/ValidateThrustersRED_ert_rtw/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c $(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2020a/toolbox/realtime/targets/raspi/server/MW_raspi_init.c $(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2020a/toolbox/realtime/targets/raspi/src/periphs/MW_Pyserver_control.c $(MATLAB_ROOT)/toolbox/target/codertarget/rtos/src/linuxinitialize.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c $(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2020a/toolbox/target/shared/file_logging/src/ert_targets_logging.c $(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2020a/toolbox/target/supportpackages/raspberrypi/src/raspi_file_logging.c

MAIN_SRC = $(START_DIR)/ValidateThrustersRED_ert_rtw/ert_main.c
...
OBJS = MW_pigs.c.o system.c.o ValidateThrustersRED.c.o ValidateThrustersRED_data.c.o rtGetInf.c.o rtGetNaN.c.o rt_nonfinite.c.o ext_svr.c.o updown.c.o ext_work.c.o rtiostream_utils.c.o MW_raspi_init.c.o MW_Pyserver_control.c.o linuxinitialize.c.o rtiostream_interface.c.o rtiostream_tcpip.c.o ert_targets_logging.c.o raspi_file_logging.c.o
...
CPP_LDFLAGS_ = -lpigpio -lpigpio -lpigpio -lpigpio -lpigpio -lpigpio -lpigpio -lpigpio -lpigpio
...
CPP_SHAREDLIB_LDFLAGS_ = -lpigpio -lpigpio -lpigpio -lpigpio -lpigpio -lpigpio -lpigpio -lpigpio -lpigpio
...
LDFLAGS_ = -lpigpio -lpigpio -lpigpio -lpigpio -lpigpio -lpigpio -lpigpio -lpigpio -lpigpio
LDFLAGS_SKIPFORSIL =  
...
SHAREDLIB_LDFLAGS_ = -lpigpio -lpigpio -lpigpio -lpigpio -lpigpio -lpigpio -lpigpio -lpigpio -lpigpio
...
%.c.o : $(START_DIR)/ValidateThrustersRED_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/ValidateThrustersRED_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/ValidateThrustersRED_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.c.o : $(START_DIR)/ValidateThrustersRED_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ValidateThrustersRED.c.o : $(START_DIR)/ValidateThrustersRED_ert_rtw/ValidateThrustersRED.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ValidateThrustersRED_data.c.o : $(START_DIR)/ValidateThrustersRED_ert_rtw/ValidateThrustersRED_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.c.o : $(START_DIR)/ValidateThrustersRED_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.c.o : $(START_DIR)/ValidateThrustersRED_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.c.o : $(START_DIR)/ValidateThrustersRED_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
