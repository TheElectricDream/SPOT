###########################################################################
## Makefile generated for Simulink model 'FloatPlatform'. 
## 
## Makefile     : FloatPlatform.mk
## Generated on : Sat Jun 20 11:22:13 2020
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/FloatPlatform.elf
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = $(MATLAB_WORKSPACE)/C/Users/AlexC/Desktop/SPOT3/Useful_Code/FloatPlatform
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C++
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/FloatPlatform.elf
...
DEFINES_ = -DMODEL=FloatPlatform -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=1 -DINTEGER_CODE=0 -DMT=0 -D__linux__ -DARM_PROJECT -D_USE_TARGET_UDP_ -D_RUNONTARGETHARDWARE_BUILD_ -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT
...
DEFINES_STANDARD = -DMODEL=FloatPlatform -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_gpio.c.o FloatPlatform.cpp.o FloatPlatform_data.cpp.o MW_raspi_init.c.o MW_Pyserver_control.c.o linuxinitialize.cpp.o
...
%.c.o : $(START_DIR)/FloatPlatform_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/FloatPlatform_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/FloatPlatform_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.cpp.o : $(START_DIR)/FloatPlatform_ert_rtw/ert_main.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


FloatPlatform.cpp.o : $(START_DIR)/FloatPlatform_ert_rtw/FloatPlatform.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


FloatPlatform_data.cpp.o : $(START_DIR)/FloatPlatform_ert_rtw/FloatPlatform_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
