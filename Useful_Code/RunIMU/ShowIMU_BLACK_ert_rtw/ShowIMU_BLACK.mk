###########################################################################
## Makefile generated for Simulink model 'ShowIMU_BLACK'. 
## 
## Makefile     : ShowIMU_BLACK.mk
## Generated on : Sat Oct 17 13:55:26 2020
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ShowIMU_BLACK.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ShowIMU_BLACK.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2020a/toolbox/target/shared/svd/include -I$(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2020a/toolbox/realtime/targets/raspi/server -I$(MATLAB_ROOT)/toolbox/shared/spc/src_ml/extern/include -I$(START_DIR)/ShowIMU_BLACK_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2020a/toolbox/realtime/targets/raspi/include -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc
...
DEFINES_ = -DMODEL=ShowIMU_BLACK -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=1 -DINTEGER_CODE=0 -DMT=0 -D__linux__ -DARM_PROJECT -D_USE_TARGET_UDP_ -D_RUNONTARGETHARDWARE_BUILD_ -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT
...
DEFINES_STANDARD = -DMODEL=ShowIMU_BLACK -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_I2C.c.o devices.c.o DAHostLib_Network.c.o DAHostLib_rtw.c.o ShowIMU_BLACK.cpp.o ShowIMU_BLACK_data.cpp.o MW_raspi_init.c.o MW_Pyserver_control.c.o linuxinitialize.cpp.o linuxUDP.c.o
...
%.c.o : $(START_DIR)/ShowIMU_BLACK_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/ShowIMU_BLACK_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/ShowIMU_BLACK_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.cpp.o : $(START_DIR)/ShowIMU_BLACK_ert_rtw/ert_main.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


ShowIMU_BLACK.cpp.o : $(START_DIR)/ShowIMU_BLACK_ert_rtw/ShowIMU_BLACK.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


ShowIMU_BLACK_data.cpp.o : $(START_DIR)/ShowIMU_BLACK_ert_rtw/ShowIMU_BLACK_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
