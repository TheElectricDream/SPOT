...
TIME_RED_SIM        = dataPacket(101:2002,1);
PX_RED_SIM          = dataPacket(101:2002,5);
PY_RED_SIM          = dataPacket(101:2002,6);
RZ_RED_SIM          = unwrap(dataPacket(101:2002,7));

TIME_BLACK_SIM      = dataPacket(101:2002,1);
PX_BLACK_SIM        = dataPacket(101:2002,14);
PY_BLACK_SIM        = dataPacket(101:2002,15);
RZ_BLACK_SIM        = unwrap(dataPacket(101:2002,16));

TIME_RED_EXP        = rt_dataPacket(231:2132,1);
PX_RED_EXP          = rt_dataPacket(231:2132,5);
PY_RED_EXP          = rt_dataPacket(231:2132,6);
RZ_RED_EXP          = unwrap(rt_dataPacket(231:2132,7));

TIME_BLACK_EXP      = rt_dataPacket(231:2132,1);
PX_BLACK_EXP        = rt_dataPacket(231:2132,14);
PY_BLACK_EXP        = rt_dataPacket(231:2132,15);
RZ_BLACK_EXP        = unwrap(rt_dataPacket(231:2132,16));
