...
TIME_RED_SIM        = dataPacket(100:end,1);
PX_RED_SIM          = dataPacket(100:end,5);
PY_RED_SIM          = dataPacket(100:end,6);
RZ_RED_SIM          = unwrap(dataPacket(100:end,7));

TIME_BLACK_SIM      = dataPacket(100:end,1);
PX_BLACK_SIM        = dataPacket(100:end,14);
PY_BLACK_SIM        = dataPacket(100:end,15);
RZ_BLACK_SIM        = unwrap(dataPacket(100:end,16));

TIME_RED_EXP        = rt_dataPacket(264:end,1);
PX_RED_EXP          = rt_dataPacket(264:end,5);
PY_RED_EXP          = rt_dataPacket(264:end,6);
RZ_RED_EXP          = unwrap(rt_dataPacket(264:end,7));

TIME_BLACK_EXP      = rt_dataPacket(264:end,1);
PX_BLACK_EXP        = rt_dataPacket(264:end,14);
PY_BLACK_EXP        = rt_dataPacket(264:end,15);
RZ_BLACK_EXP        = unwrap(rt_dataPacket(264:end,16));
