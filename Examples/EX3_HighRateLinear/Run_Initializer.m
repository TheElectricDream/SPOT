...
Phase3_SubPhase4_Duration      = 102;      % [s]
...
drop_states_RED           =  [2.46125561523438,1.19804431152344,-3.12767314910889]; % [m; m; rad]
drop_states_BLACK         =  [1.77023596191406,1.22022058105469,-0.0191568210721016];  % [m; m; rad]

init_states_RED           = [ xLength/2+0.7; yLength/2; pi]; % [m; m; rad]
init_states_BLACK         = [ xLength/2; yLength/2; 0];      % [m; m; rad]

home_states_RED           = [ xLength/2; yLength/2+0.4; pi]; % [m; m; rad]
